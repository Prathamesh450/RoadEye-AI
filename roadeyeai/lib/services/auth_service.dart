...
class AuthService {
  ...
  // ========================================
  // ✅ FORGOT PASSWORD - USING BACKEND EMAIL
  // ========================================
  static Future<Map<String, dynamic>> forgotPassword(String email) async {
    try {
      ...
      print('📡 Using URL: ${ApiConfig.baseUrl}/forgot-password');
      ...
      if (response.statusCode == 200 && data['success'] == true) {
        ...
        return {
          'success': true,
          'message': data['message'] ?? 'Password reset instructions sent! Check your email.',
        };
      } else {
        print('❌ Password reset error: ${data['error']}');
        return {
          'success': false,
  ...
  static Future<Map<String, dynamic>> registerWithOTP(
    ...
    try {
      ...
      print('📡 Using URL: ${ApiConfig.signupWithOtp}');
  ...
  static Future<Map<String, dynamic>> sendOTP(String email) async {
    try {
      ...
      print('📡 Using URL: ${ApiConfig.sendOtp}');
  ...
  static Future<Map<String, dynamic>> verifyOTP(String email, String otp) async {
    try {
      ...
      print('📡 Using URL: ${ApiConfig.verifyOtp}');
